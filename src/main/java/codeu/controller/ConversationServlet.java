...
public class ConversationServlet extends HttpServlet {
  ...
  /**
   * This function fires when a user navigates to the conversations page. It gets
   * all of the conversations from the model and forwards to conversations.jsp for
   * rendering the list.
   */
  @Override
   ...
   * title from the submitted form data. It uses this to create a new Conversation
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    if (shouldDelete) {
      conversationStore.deleteConversation(
          conversationStore.getConversation(UUID.fromString(request.getParameter("conversationId"))));
      response.sendRedirect("/conversations");
      return;
    }
    ...
    if (conversationStore.isTitleTaken(conversationTitle)) {
      // conversation title is already taken, just go into that conversation instead
      // of creating a
      // new one
