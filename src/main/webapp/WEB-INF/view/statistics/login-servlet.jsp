...
<head>
  ...
  <script type="text/javascript">
    ...
    function drawFirstChart() {
      ...
      <% List<Statistic> statistics = instance.loadStatistics(Type.LOGIN_SERVLET_GET_TIME); %>
      var table = new Array();
      ...
      // Set chart options
      var options = {'title':'Login Servlet GET Elapsed Time',
                     'width':800,
                     'height':600,
    ...
    function drawSecondChart() {
        ...
        <% statistics = instance.loadStatistics(Type.LOGIN_SERVLET_POST_TIME); %>
        var table = new Array();
        <% for (int i = 0; i < statistics.size(); i++) {
             String date = statistics.get(i).getCreationTimeString();
             long value = statistics.get(i).getValue();
        ...
        var options = {'title':'Login Servlet POST Elapsed Time',
                       'width':800,
                       'height':600,
                       'backgroundColor':'#f6f6f6',
                       'colors':['green'],
...
<body>
  ...
  <div id="sidenav">
      ...
      <a style="color:#202020;" href="/statistics/login-servlet">Login Servlet</a><br>
