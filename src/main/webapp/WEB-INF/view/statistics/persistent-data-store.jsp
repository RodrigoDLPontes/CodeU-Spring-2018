  ...
  <script type="text/javascript">
    ...
    function drawFirstChart() {
      ...
      <% List<Statistic> statistics = instance.loadStatistics(
           Type.PERSISTENT_DATA_STORE_LOAD_CONVERSATIONS_TIME); %>
      var table = new Array();
      ...
      // Set chart options
      var options = {'title':'Persistant Data Store loadConversations() Elapsed Time',
                     'width':800,
                     'height':600,
      ...
      var chart = new google.visualization.LineChart(document.getElementById(
              'load_conversations_chart_div'));
      chart.draw(data, options);
    }

    function drawSecondChart() {

        <% statistics = instance.loadStatistics(Type.PERSISTENT_DATA_STORE_LOAD_MESSAGES_TIME); %>
        var table = new Array();
        <% for (int i = 0; i < statistics.size(); i++) {
             String date = statistics.get(i).getCreationTimeString();
             long value = statistics.get(i).getValue();
        ...
        var options = {'title':'Persistant Data Store loadMessages() Elapsed Time',
                       'width':800,
                       'height':600,
                       'backgroundColor':'#f6f6f6',
                       'colors':['green'],
        ...
        var chart = new google.visualization.LineChart(document.getElementById(
                'load_messages_chart_div'));
        chart.draw(data, options);
    }

    function drawThirdChart() {

        <% statistics = instance.loadStatistics(Type.PERSISTENT_DATA_STORE_LOAD_USERS_TIME); %>
        var table = new Array();
        <% for (int i = 0; i < statistics.size(); i++) {
             String date = statistics.get(i).getCreationTimeString();
             long value = statistics.get(i).getValue();
        ...
        var options = {'title':'Persistant Data Store loadUsers() Elapsed Time',
                       'width':800,
                       'height':600,
                       'backgroundColor':'#f6f6f6',
                       'colors':['green'],
    ...
    function drawFourthChart() {
        ...
        <% statistics = instance.loadStatistics(
             Type.PERSISTENT_DATA_STORE_WRITE_THROUGH_CONVERSATION_TIME); %>
        var table = new Array();
        <% for (int i = 0; i < statistics.size(); i++) {
             String date = statistics.get(i).getCreationTimeString();
             long value = statistics.get(i).getValue();
        ...
        var options = {'title':'Persistant Data Store writeThrough(Conversation) Elapsed Time',
                       'width':800,
                       'height':600,
                       'backgroundColor':'#f6f6f6',
                       'colors':['green'],
    ...
    function drawFifthChart() {
        ...
        <% statistics = instance.loadStatistics(
             Type.PERSISTENT_DATA_STORE_WRITE_THROUGH_MESSAGE_TIME); %>
        var table = new Array();
        <% for (int i = 0; i < statistics.size(); i++) {
             String date = statistics.get(i).getCreationTimeString();
             long value = statistics.get(i).getValue();
        ...
        var options = {'title':'Persistant Data Store writeThrough(Message) Elapsed Time',
                       'width':800,
                       'height':600,
                       'backgroundColor':'#f6f6f6',
                       'colors':['green'],
    ...
    function drawSixthChart() {
        ...
        <% statistics = instance.loadStatistics(
             Type.PERSISTENT_DATA_STORE_WRITE_THROUGH_USER_TIME); %>
        var table = new Array();
        <% for (int i = 0; i < statistics.size(); i++) {
             String date = statistics.get(i).getCreationTimeString();
             long value = statistics.get(i).getValue();
        ...
        var options = {'title':'Persistant Data Store writeThrough(User) Message Time',
                       'width':800,
                       'height':600,
                       'backgroundColor':'#f6f6f6',
                       'colors':['green'],
...
<body>
  ...
  <div id="sidenav">
      ...
      <a style="color:#202020;" href="/statistics/persistent-data-store">Persistant Data Store</a><br>
  ...
  <div id="container">
    ...
    <div id="load_conversations_chart_div"></div>
    <br>
    <div id="load_messages_chart_div"></div>
    <br>
    <div id="load_users_chart_div"></div>
    <br>
    <div id="write_conversation_chart_div"></div>
    <br>
    <div id="write_message_chart_div"></div>
    <br>
    <div id="write_user_chart_div"></div>
    <br>
  </div>
