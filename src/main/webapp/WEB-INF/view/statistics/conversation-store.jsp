  ...
  <script type="text/javascript">
    ...
    function drawFirstChart() {
      ...
      <% List<Statistic> statistics = instance.loadStatistics(
           Type.CONVERSATION_STORE_ADD_CONVERSATION_TIME); %>
      var table = new Array();
      ...
      // Set chart options
      var options = {'title':'Conversation Store addConversation() Elapsed Time',
                     'width':800,
                     'height':600,
    ...
    function drawSecondChart() {
        ...
        <% statistics = instance.loadStatistics(
             Type.CONVERSATION_STORE_GET_CONVERSATION_WITH_TITLE_COMPS); %>
        var table = new Array();
        <% for (int i = 0; i < statistics.size(); i++) {
             String date = statistics.get(i).getCreationTimeString();
             long value = statistics.get(i).getValue();
        ...
        var options = {'title':'Conversation Store getConversationWithTitle() Number of Comparisons',
                       'width':800,
                       'height':600,
                       'backgroundColor':'#f6f6f6',
                       'colors':['green'],
    ...
    function drawThirdChart() {
        ...
        var options = {'title':'Conversation Servlet isTitleTaken() Number of Comparisons',
                       'width':800,
                       'height':600,
                       'backgroundColor':'#f6f6f6',
                       'colors':['green'],
...
<body>
  ...
  <div id="container">
    <h1>Statistics</h1>
    <h2>Conversation Store</h2>
    <!--Div that will hold the line chart-->
    <div id="add_conversation_chart_div"></div>
    <br>
    <div id="get_conversation_chart_div"></div>
    <br>
    <div id="is_title_taken_chart_div"></div>
    <br>
  </div>
