...
public class BBCodeParserTest {
    ...
    public void testParse_MultipleTagPairsParallelAndNested() {
        String input = "[b]leftleft1[b]left1[b]center1[/b]right1[/b]rightright1[/b][b]leftleft2[b]left2[b]center2[/b]right2[/b]rightright2[/b]";
        String expected = "<b>leftleft1<b>left1<b>center1</b>right1</b>rightright1</b><b>leftleft2<b>left2<b>center2</b>right2</b>rightright2</b>";
        String actual = BBCodeParser.parse(input);
